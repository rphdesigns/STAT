    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Ticket Display - <?php echo $ticket_display_row[0]; ?></h1>
          <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group mr-2">
              <a href="Ticket_Entry.php"><button type="button" class="btn btn-sm btn-outline-secondary">Ticket Entry</button></a>
            ...
            <div class="col-md-8 order-md-1">
              <div class="row">
                ...
                <div class="col-md-8 mb-3">
                  <p><?php echo $ticket_display_row[1]; ?></p>
                  <p><?php echo $ticket_display_row[2]; ?></p>
                  <p><?php echo $ticket_display_row[3]; ?></p>
                  <p><?php echo $ticket_display_row[4]; ?></p>
                </div>
              </div>
            </div>
          </div>
